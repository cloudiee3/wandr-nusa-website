        ...
        <div className="wrap grid grid-cols-2 gap-px sm:grid-cols-3 lg:grid-cols-6">
          {facts.map(({ icon: Icon, label, value }) => (
            <div key={label} className="py-6 pr-6">
              <span className="inline-flex items-center gap-2 font-mono text-[10px] uppercase tracking-label text-ink-300">
          ...
          <div className="py-6">
            <span className="font-mono text-[10px] uppercase tracking-label text-ink-300">
          ...
          <ol className="mt-8 space-y-0">
            {j.itinerary.map((d, i) => (
              <Reveal as="li" key={d.day} delay={i * 90} className="relative flex gap-6 pb-10 last:pb-0">
                ...
                <span className="relative z-10 flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-sea-500/25 bg-sea-100 font-mono text-[11px] text-sea-700">
                  {i + 1}
                </span>
                <div className="pt-1">
                  <span className="font-mono text-[10px] uppercase tracking-label text-ink-300">{d.day}</span>
