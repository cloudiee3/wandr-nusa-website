...
export default function WhatsAppFab() {
  ...
  return (
    ...
    >
      ...
      <span className="max-w-0 overflow-hidden whitespace-nowrap font-sans text-sm font-medium opacity-0 transition-all duration-500 group-hover:max-w-[10rem] group-hover:opacity-100">
        Chat with us
      </span>
    </a>
  )
