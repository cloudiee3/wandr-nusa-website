/** The WhatsApp mark. One copy, used by every WhatsApp link on the site. */
export default function WhatsAppIcon({ className = 'h-4 w-4' }) {
  return (
    <svg viewBox="0 0 24 24" className={`${className} fill-current`} aria-hidden="true" focusable="false">
