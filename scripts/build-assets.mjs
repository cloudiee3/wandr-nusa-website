...
const PHOTO_MAP = {
  ...
  'pink-beach-boat':     ['Pink Beach Boat.jpg', 'A wooden boat drawn up on the pink sand at Tangsi, with green hills behind'],
  'pink-beach-wide':     ['Pink Beach Wide.jpg', 'The long pink sweep of Pink Beach with hills across the bay'],
  'reef-bay-aerial':     ['Reef Bay Aerial.jpg', 'Aerial view of a reef-flecked bay with fishing boats moored off the sand'],
  'outrigger-aerial':    ['Outrigger Aerial.jpg', 'An outrigger boat from directly above, on the line between reef and deep water'],
