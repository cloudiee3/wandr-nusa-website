...
| ☐ | **The social links go nowhere.** Instagram, Facebook and GetYourGuide point at those sites' front pages, not at your profiles. Send the four real URLs. | A footer icon that opens instagram.com looks broken. |
| ☐ | **The GetYourGuide mark is a stand-in.** A ticket icon, because their logo is a trademark and drawing it from memory would misrepresent their brand. Their partner assets have the real SVG. | |
| ☐ | **The phone number and the registration line are still unverified.** `+62 823 4081 9128`, and "Registered in Nusa Tenggara Barat, Indonesia" in the footer. The email and the Tetebatu address are now real. | |
| ☐ | **The Contact page still lists opening hours**, including "Messages answered" on Sunday — the lines taken out of the footer. Same treatment there, or keep them deliberately. | |
