...
export const STRINGS = {
  en: {
    ...
    'meta.description': 'Lombok and the Nusa Islands — reef islands, empty beaches, waterfalls in the hills and a mountain holding the middle.',
    'nav.home': 'Home',
    ...
    'cta.seeTours': 'See the escapes',
    'cta.requestTrip': 'Tell us where',
    'cta.sendWhatsapp': 'Send on WhatsApp',
    'lang.label': 'Language',
    'hero.titleA': 'Some islands you visit.',
    'hero.titleB': 'This one, you wander.',
    'hero.eyebrow': 'Lombok · Nusa Islands · Indonesia',
    'hero.lead': 'Reef islands off one coast, empty beaches along another, waterfalls in the hills and a mountain holding the middle. Most people leave already planning the next one.',
  ...
  id: {
    ...
    'request.eyebrow': 'Atas permintaan',
    'meta.title': 'wandrnusa — escape di Lombok dan Kepulauan Nusa',
    'meta.description': 'Lombok dan Kepulauan Nusa — pulau karang, pantai sepi, air terjun di perbukitan, dan gunung yang memegang bagian tengahnya.',
    'nav.home': 'Beranda',
    'nav.about': 'Pulau ini',
    'nav.tours': 'Escape',
    'nav.contact': 'Kontak',
    ...
    'cta.seeTours': 'Lihat escape kami',
    'cta.requestTrip': 'Sebutkan tujuannya',
    'cta.sendWhatsapp': 'Kirim via WhatsApp',
    'lang.label': 'Bahasa',
    'hero.titleA': 'Pulau lain dikunjungi.',
    'hero.titleB': 'Yang ini, dijelajahi.',
    'hero.eyebrow': 'Lombok · Kepulauan Nusa · Indonesia',
    'hero.lead': 'Pulau-pulau karang di satu sisi, pantai sepi di sisi lain, air terjun di perbukitan, dan gunung yang memegang bagian tengahnya. Kebanyakan orang pulang sambil sudah merencanakan kunjungan berikutnya.',
